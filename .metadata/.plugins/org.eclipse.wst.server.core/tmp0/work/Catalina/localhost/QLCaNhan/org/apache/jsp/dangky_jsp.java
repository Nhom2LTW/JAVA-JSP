 ...
 * Generated at: 2016-10-15 15:17:51 UTC
...
public final class dangky_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<li class=\"active\"><a href=\"dangky.jsp\">Đăng Ký</a></li>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<label for=\"username\" class=\"col-xs-3 control-label\">Họ\r\n");
      out.write("\t\t\t\t\t\t\t\tTên</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-xs-4\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input class=\"form-control\" name=\"username\" ng-model=\"username\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttype=\"text\" placeholder=\"Họ Tên\" ng-maxlength=\"20\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tng-pattern=\"/^[a-zA-Z ]+$/\" required>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-xs-4\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<i class=\"fa fa-check text-success\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tng-show=\"form.username.$dirty && form.username.$valid\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div ng-show=\"form.username.$dirty && form.username.$invalid\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"text-danger\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<i class=\"fa fa-times text-danger\"></i> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tng-show=\"form.username.$error.required\">Họ tên không\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tđược bỏ trống</span> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tng-show=\"form.username.$error.maxlength\">Họ tên phải\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tngắn hơn 20 kí tự</span> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tng-show=\"form.username.$error.pattern\">Họ tên chỉ bao\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tgồm các kí tự chữ cái</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"birthday\" class=\"col-xs-3 control-label\">Ngày\r\n");
      out.write("\t\t\t\t\t\t\t\tsinh</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-xs-4\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input class=\"form-control\" name=\"birthday\" ng-model=\"birthday\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttype=\"text\" placeholder=\"dd-mm-yyyy\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tng-pattern=\"/^(0?[1-9]|[12][0-9]|3[01])-(0?[1-9]|1[012])-((19[0-9]{2})|(20[0-1]{1}[0-4]{1}))$/\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-xs-4\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<i class=\"fa fa-check text-success\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tng-show=\"form.birthday.$dirty && form.birthday.$valid\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div ng-show=\"form.birthday.$dirty && form.birthday.$invalid\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"text-danger\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<i class=\"fa fa-times text-danger\"></i> <span>Nhập\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tngày sinh theo đúng định dạng dd-mm-yyyy {{birthday}}</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"email\" class=\"col-xs-3 control-label\">Email</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-xs-4\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input class=\"form-control\" name=\"email\" ng-model=\"email\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttype=\"email\" placeholder=\"Email\" required>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-xs-4\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<i class=\"fa fa-check text-success\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tng-show=\"form.email.$dirty && form.email.$valid\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div ng-show=\"form.email.$dirty && form.email.$invalid\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"text-danger\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<i class=\"fa fa-times text-danger\"></i> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tng-show=\"form.email.$error.required\">Bạn chưa nhập\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tđịa chỉ email</span> <span ng-show=\"form.email.$error.email\">Không\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tđúng định dạng email</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<label for=\"phonenumber\" class=\"col-xs-3 control-label\">Số\r\n");
      out.write("\t\t\t\t\t\t\t\tĐiện Thoại</label>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-xs-4\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input class=\"form-control\" name=\"phonenumber\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tng-model=\"phonenumber\" type=\"text\" placeholder=\"Số Điện Thoại\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tng-minlength=\"10\" ng-maxlength=\"11\" ng-pattern=\"/^[0-9]+$/\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\trequired>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-xs-4\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<i class=\"fa fa-check text-success\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tng-show=\"form.phonenumber.$dirty && form.phonenumber.$valid\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t<!--Dấu check thể hiện việc nhập dữ liệu được nhập là hợp lệ-->\r\n");
      out.write("\t\t\t\t\t\t\t\t<div\r\n");
      out.write("\t\t\t\t\t\t\t\t\tng-show=\"form.phonenumber.$dirty && form.phonenumber.$invalid\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"text-danger\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<i class=\"fa fa-times text-danger\"></i> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tng-show=\"form.phonenumber.$error.required\">Ban chưa\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tnhập số điện thoại</span> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tng-show=\"form.phonenumber.$error.minlength\">Số điện\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tthoại không phù hợp</span> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tng-show=\"form.phonenumber.$error.maxlength\">Số điện\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tthoại không phù hợp</span> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tng-show=\"form.phonenumber.$error.pattern\">Số điện thoại\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tchỉ gồm kí tự 0-9</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
